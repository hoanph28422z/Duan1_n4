...
<body>
    ...
    <main>
        <section class="about__area about__area--2 position-relative pt-125 pb-105">
            <span class="shape shape__1 position-absolute"><img src="show_pro/assets/images/shape/about-shape-2-1.png" alt=""></span>
            <span class="shape shape__2 position-absolute"><img src="show_pro/assets/images/shape/about-shape-2-2.png" alt=""></span>
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-7">
                        <div class="about__left about__left--2 position-relative">
                            <img class="big" src="show_pro/assets/images/about/about-img-2-1.png" alt="img">
                            <img class="small position-absolute" src="show_pro/assets/images/about/about-img-2-2.png" alt="img">
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row mt-none-30">
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30 text-center">
                        <div class="wcu__item">
                            <div class="icon">
                                <img src="show_pro/assets/images/icons/wcu-1.png" alt="">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30 text-center">
                        <div class="wcu__item">
                            <div class="icon">
                                <img src="show_pro/assets/images/icons/wcu-2.png" alt="">
                            </div>
                            <div class="content">
        ...
        <div class="best-coffe__area position-relative">
            <div class="best-coffe__bg">
                <img src="show_pro/assets/images/bg/best-coffe-1.jpg" alt="">
            </div>
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="row mt-none-30">
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                        <div class="team__box">
                            <div class="thumb mb-30">
                                <img src="show_pro/assets/images/team/team-1.jpg" alt="">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                        <div class="team__box">
                            <div class="thumb mb-30">
                                <img src="show_pro/assets/images/team/team-2.jpg" alt="">
                                <div class="social-links">
