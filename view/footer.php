<section class="footer" id="footer">
        <div class="footer-box">
            <h2>Coffee Shop</h2>
            <br>
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit corrupti ullam odit et? Error laboriosam iusto minus, doloremque quia animi maiores quos iure qui quae! Fuga debitis temporibus hic excepturi.</p>
            <div class="social">
        ...
        <div class="footer-box flex">
            <h3>Contact</h3>
            <span><i class="bx bx-map"></i>16 Trịnh Văn Bô</span>
            <span> <i class="bx bx-phone"></i>0364.009.051</span>
